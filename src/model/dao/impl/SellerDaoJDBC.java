...
public class SellerDaoJDBC implements SellerDao {
    ...
    private Seller instantiateSeller(ResultSet rs, Department dep) throws SQLException {
        ...
        // nesta função não iremos tratar a excessão pois já tratamos na especifica
    ...
    public List<Seller> findAll() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                // se o departament existir meu map.get vai pegar ele
                Department dep = map.get(rs.getInt("DepartmentId"));

                // se não ele vai instanciar e salvar no map
                if (dep == null) {
    ...
    // neste código eu faço 1 departamento apontar para varios vendedores
    @Override
